...
disp(' 2) small .eps file creation (for side?by?side on page)'); disp(' 3) large .eps file creation (full width figures)'); disp(' 4) figure preferences for Dominic Vella');
disp(' 9) other');
    wh = input('choose #:  ');
  else
wh = varargin{1}; end
...
case 1
disp('setting figure preferences for small bitmap creation'); disp('** This is intended to create small (?r40) bitmaps'); disp(' for example for Web presentation.');
set(0, 'DefaultAxesFontSize', 20)
set(0, 'DefaultLineMarkerSize', 12);
case 2
disp('setting figure preferences for small .eps file creation'); disp('** This is intended to create figures which will be'); disp(' displayed side?by?side with another figure in LaTeX.'); % this is what Trefethen used to create the figures for
